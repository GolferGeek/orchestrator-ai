...
export class ConversationRequestDto {
  @ApiProperty({
    description:
      'Agent conversation ID (optional - will be created if not provided)',
    format: 'uuid',
    required: false,
  })
  @IsUUID()
...
export class ConversationResponseDto {
  ...
  @ApiProperty({
    ...
    example:
      'I have written a comprehensive blog post about artificial intelligence. You can find it in the message above.',
  })
  responseText!: string;
  ...
  @ApiProperty({
    ...
    example:
      'data:audio/mp3;base64,SUQzBAAAAAAAI1RTU0UAAAAPAAADTGF2ZjU4Ljc2LjEwMAAAAAAAAAAA...',
  })
