...
describe('SecretRedactionService - Comprehensive Pattern Testing', () => {
  ...
  describe('Pattern 1: Generic API Keys', () => {
    const testCases = [
      {
        text: 'api_key=sk1234567890abcdef1234567890abcdef1234567890',
        name: 'underscore format',
      },
      {
        text: 'api-key: "abc123def456ghi789jkl012mno345pqr678stu901"',
        name: 'dash format with quotes',
      },
      {
      ...
      {
        text: 'key: xyz789abc123def456ghi789jkl012',
        name: 'simple key format',
      },
      {
        text: 'API_KEY = ghijklmnop1234567890qrstuvwxyz',
        name: 'uppercase with spaces',
      },
      {
        text: 'Api-Key:mnbvcxz0987654321poiuytrewqlkjhg',
        name: 'mixed case with colon',
      },
      {
        text: 'apiKey="zxcvbnmasdfghjklqwertyuiopZXCVBN"',
        name: 'camelCase with quotes',
      },
      { text: "key='123456789abcdefghijklmnopqrstuvw'", name: 'single quotes' },
      {
        text: 'secret_key = abcDEF123456789ghiJKL012mnoPQR345',
        name: 'secret_key variant',
      },
      {
        text: 'access_key:qwertyuiopasdfghjklzxcvbnm123456',
        name: 'access_key variant',
      },
      {
        text: 'client_key = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdef"',
        name: 'client_key variant',
      },
      {
        text: 'token_key:1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6p',
        name: 'token_key variant',
      },
      {
        text: 'private_key="zaq1xsw2cde3vfr4bgt5nhy6mju7kilo8"',
        name: 'private_key variant',
      },
      {
        text: 'auth_key = plmnbvcxzasqwedrtyfghijk12345678',
        name: 'auth_key variant',
      },
      {
        text: 'service-key: mnbvcxzlkjhgfdsapoiuytrewq098765',
        name: 'service-key variant',
      },
    ];
  ...
  describe('Pattern 2: Bearer Tokens', () => {
    const testCases = [
      {
        text: 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9eyJzdWIiOiIxMjM',
        name: 'standard bearer token',
      },
      {
        text: 'token abcd1234567890efghijklmnopqrstuvwxyz1234567890',
        name: 'simple token format',
      },
      {
        text: 'Bearer 1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6p7q8r9s0t',
        name: 'bearer with mixed case',
      },
      {
        text: 'TOKEN ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890abcdef',
        name: 'uppercase token',
      },
      {
        text: 'access_token ghijklmnopqrstuvwxyz1234567890ABCDEF',
        name: 'access_token format',
      },
      {
        text: 'bearer zxcvbnmasdfghjklqwertyuiopZXCVBNM123456',
        name: 'lowercase bearer',
      },
      {
        text: 'token:qwertyuiop0987654321asdfghjklzxcvbnm',
        name: 'token with colon',
      },
      {
        text: 'Bearer\tyhjukilo.mnbvcxzasqwedrtyfghijk123',
        name: 'bearer with tab and dot',
      },
      {
        text: 'auth_token plokijuhygtfrdeswaqzxcvbnmqazwsx123',
        name: 'auth_token format',
      },
      {
        text: 'session_token 1q2w3e4r5t6y7u8i9o0pazsxdcfvgbhnjm',
        name: 'session_token format',
      },
      {
        text: 'refresh_token mnbvcxzaqwsxcderfvbgtyhnujmikolpqaz',
        name: 'refresh_token format',
      },
      {
        text: 'id_token 9876543210fedcba0987654321zyxwvuts',
        name: 'id_token format',
      },
    ];
    ...
    const testCases = [
      {
        ...
        name: 'numeric start key',
      },
      {
        text: 'sk-abcdefghijklmnopqrstuvwxyz1234567890ABCDEFGHIJKL',
        name: 'mixed case key',
      },
      {
        text: 'sk-proj1234567890abcdef1234567890abcdef1234567890ab',
        name: 'project key format',
      },
      {
        text: 'sk-ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuv',
        name: 'uppercase start key',
      },
      {
        text: 'sk-zxcvbnmasdfghjklqwertyuiopZXCVBNMASDFGHJKLQWERTY',
        name: 'keyboard pattern key',
      },
      {
        text: 'sk-9876543210fedcba9876543210FEDCBA9876543210fedcba',
        name: 'reverse hex key',
      },
      {
        text: 'sk-1a2b3c4d5e6f7g8h9i0j1k2l3m4n5o6p7q8r9s0t1u2v3w4x',
        name: 'alternating key',
      },
      {
        text: 'sk-qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKL123',
        name: 'qwerty pattern key',
      },
      {
        text: 'sk-aaaabbbbccccddddeeeeffffgggghhhhiiiijjjjkkkllllm',
        name: 'repeated chars key',
      },
      {
        text: 'sk-Z9Y8X7W6V5U4T3S2R1Q0P9O8N7M6L5K4J3I2H1G0F9E8D7C6',
        name: 'descending key',
      },
    ];
  ...
  describe('Pattern 4: Anthropic API Keys', () => {
    ...
    const testCases = [
      ...
      {
        text: 'sk-ant-api03-' + '1234567890'.repeat(9) + '12345',
        name: 'numeric pattern',
      },
      {
        text: 'sk-ant-api03-' + 'abcdefghij'.repeat(9) + 'klmno',
      ...
      {
        text: 'sk-ant-api03-' + 'aB1cD2eF3g'.repeat(9) + 'H4iJ5',
        name: 'mixed case numbers',
      },
      {
        text: 'sk-ant-api03-' + 'qwertyuiop'.repeat(9) + 'asdfg',
        name: 'keyboard pattern',
      },
      {
        text: 'sk-ant-api03-' + 'zxcvbnmqwe'.repeat(9) + 'rtyui',
        name: 'reverse keyboard',
      },
      {
        text: 'sk-ant-api03-' + '9876543210'.repeat(9) + '98765',
        name: 'descending numbers',
      },
      {
        text: 'sk-ant-api03-' + 'zyxwvutsrq'.repeat(9) + 'ponml',
        name: 'reverse alphabet',
      },
      {
        text: 'sk-ant-api03-' + 'aAbBcCdDeE'.repeat(9) + 'fFgGh',
  ...
  describe('Pattern 5: Google API Keys', () => {
    ...
    const testCases = [
      ...
      {
        text: 'AIzaABCDEFGHIJKLMNOPQRSTUVWXYZ123456789',
        name: 'uppercase mix',
      },
      {
        text: 'AIzaqwertyuiopasdfghjklzxcvbnm123456789',
        name: 'keyboard pattern',
      },
      {
        text: 'AIzaBcDeFgHiJkLmNoPqRsTuVwXyZ1234567890',
        name: 'mixed case standard',
      },
      {
        text: 'AIza9876543210zyxwvutsrqponmlkjihgfedcb',
        name: 'reverse pattern',
      },
      {
        text: 'AIzaaAbBcCdDeEfFgGhHiIjJkKlLmMnNoOpPqRS',
        name: 'alternating case',
      },
      {
        text: 'AIzaSy123456789012345678901234567890123',
        name: 'mostly numeric',
      },
      {
        text: 'AIzaBcXyZ123XyZ123XyZ123XyZ123XyZ123456',
    ...
    const testCases = [
      {
        ...
        name: 'standard HS256 JWT',
      },
      {
        text:
          'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJqb2UiLCJleHAiOjEzMDA4MTkzODAsImh0dHA6Ly9leGFtcGxlLmNvbS9pc19yb290Ijp0cnVlfQ.cC4hiUPoj9Eetdgtv3hF80EGrhuB__dzERat0XF9g2VtQgr9PkJi' +
          'Qz1Sb6_MHcg-98yz2vDbFXYT6-nBqlCo3',
        name: 'RS256 JWT',
      },
      {
        text: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJPbmxpbmUgSldUIEJ1aWxkZXIiLCJpYXQiOjE2NzEyMzQ1NjcsImV4cCI6MTcwMjc3MDU2NywiYXVkIjoid3d3LmV4YW1wbGUuY29tIiwic3ViIjoidGVzdEBleGFtcGxlLmNvbSJ9.abc123def456789ghi012jkl345mno678pqr901stu234vwx567',
        name: 'JWT with longer payload',
      },
      {
        text: 'eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.abc_def-123_456-789_012-345_678-901_234-567_890-abc_def-ghi',
        name: 'ES256 JWT with underscores/dashes',
      },
      {
        text: 'eyJhbGciOiJub25lIiwidHlwIjoiSldUIn0.eyJzdWIiOiJ0ZXN0IiwibmFtZSI6IlRlc3QgVXNlciIsImFkbWluIjp0cnVlfQ.',
        name: 'unsecured JWT (no signature)',
      },
      {
        text:
          'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.VFb0_ikz0FppCTJf_N5g7S3tDoz6K7TK0--' +
          'UWJhHQvZP1fGyfEfhGmxD5uJPdJJ9Aew4RbTlPJ2OU1ZIz5yF6w',
        name: 'HS512 JWT',
      },
      {
        text: 'Authorization: Bearer eyJhbGciOiJSUzI1NiJ9.eyJpc3MiOiJqb2UifQ.A6KTvGp3YqCKjTySAY20sSgGdE8wB5T8lG9HJ4L_RjM',
        name: 'JWT in auth header',
      },
      {
        text: 'token=eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoidGVzdCJ9.abc123def456ghi789jkl012mno345',
        name: 'JWT as token parameter',
      },
    ];
  ...
  describe('Pattern 7: Passwords', () => {
    const testCases = [
      ...
      {
        text: 'PASSWORD = VeryStrongP@ssw0rd2024!',
        name: 'uppercase with spaces',
      },
      { text: 'password:"C0mpl3xP@ssw0rd!2024"', name: 'password with colon' },
      { text: "pwd='SingleQuotePassword123!'", name: 'single quoted password' },
      {
        text: 'pass: MyLongPasswordWithManyCharacters123!@#$%^&*()',
        name: 'very long password',
      },
      {
        text: 'password\t=\tTabSeparatedPassword123',
        name: 'tab separated password',
      },
      {
        text: 'user_password=UserSpecificP@ss123',
        name: 'user_password variant',
      },
      { text: 'admin_pass: AdminP@ssword2024!', name: 'admin_pass variant' },
      {
        text: 'db_password="DatabaseP@ssw0rd123!"',
  ...
  describe('Pattern 8: Database URLs', () => {
    const testCases = [
      {
        text: 'postgresql://username:password123@localhost:5432/mydb',
        name: 'PostgreSQL local',
      },
      {
        text: 'mysql://dbuser:secretpass@db.example.com:3306/production',
        name: 'MySQL remote',
      },
      {
        text: 'mongodb://admin:complexPassword!@cluster0.mongodb.net/myapp',
        name: 'MongoDB Atlas',
      },
      {
        text: 'postgresql://user:p@ss!w0rd@db-server:5432/database_name',
        name: 'PostgreSQL with special chars',
      },
      {
        text: 'mysql://root:admin123@127.0.0.1:3306/test_db',
        name: 'MySQL with IP',
      },
      {
        text: 'mongodb://user:mypassword@mongo1.example.com:27017,mongo2.example.com:27017/replica_set',
        name: 'MongoDB replica set',
      },
      {
        text: 'postgresql://postgres:super_secret_password@prod-db.company.com:5432/main_app',
        name: 'PostgreSQL production',
      },
      {
        text: 'mysql://api_user:ApiP@ssw0rd2024@mysql.amazonaws.com:3306/api_database',
        name: 'MySQL AWS RDS',
      },
      {
        text: 'mongodb://app:application_password@mongo.cloud.mongodb.com:27017/app_data',
        name: 'MongoDB cloud',
      },
    ];
  ...
  describe('Pattern 10: Credit Cards', () => {
    const testCases = [
      ...
      { text: 'Account: 5105105105105100', name: 'Mastercard no separators' },
      {
        ...
        name: 'Test Visa with dashes',
      },
      {
        text: 'Payment Method: 5200 8282 8282 8210',
        name: 'Test Mastercard with spaces',
      },
  ...
  describe('Comprehensive All-Pattern Test with Validation', () => {
    it('should redact all pattern types and validate complete coverage', () => {
      ...
      const originalSecrets = {
        ...
        databaseUrl:
          'postgresql://username:secretpassword@db.example.com:5432/production',
...
-----END RSA PRIVATE KEY-----`,
      ...
      expect(result.redactedText.length).toBeLessThan(
