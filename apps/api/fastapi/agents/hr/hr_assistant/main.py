...
from apps.api.fastapi.a2a_protocol.task_store import TaskStoreService # TaskAndHistory removed
...
from apps.api.fastapi.shared.mcp.mcp_client import MCPClient # Specific errors handled by base
from apps.api.fastapi.main import get_original_http_client # Import the http_client provider
from apps.api.fastapi.agents.base.mcp_context_agent_base import MCPContextAgentBaseService # Import the new base class
