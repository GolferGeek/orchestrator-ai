...
from apps.api.fastapi.a2a_protocol.types import (
    AgentCard,
    AgentCapability,
    TextPart,
...
from apps.api.fastapi.shared.mcp.mcp_client import MCPClient # MCPError etc are handled by base class now
from apps.api.fastapi.agents.base.mcp_context_agent_base import MCPContextAgentBaseService
from apps.api.fastapi.a2a_protocol.task_store import TaskStoreService # Needed for base class
from apps.api.fastapi.main import get_original_http_client, get_original_task_store_service # MODIFIED: Added get_original_task_store_service
