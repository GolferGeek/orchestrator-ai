...
from .schemes import oauth2_scheme # MODIFIED: Import from new central location
...
async def get_current_authenticated_user(
    ...
    token: Optional[str] = Depends(oauth2_scheme), # MODIFIED: Uses centrally defined oauth2_scheme
...
async def get_supabase_client_as_current_user(
    token: str = Depends(oauth2_scheme) # MODIFIED: Uses centrally defined oauth2_scheme
