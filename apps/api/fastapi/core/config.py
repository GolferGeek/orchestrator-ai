...
# This config.py is at apps/api/fastapi/core/config.py
...
_calculated_project_root_for_pydantic = Path(__file__).resolve().parents[4]
_dotenv_path_for_pydantic_config = _calculated_project_root_for_pydantic / ".env"

DEFAULT_MARKDOWN_CONTEXT_PATH = _calculated_project_root_for_pydantic / "apps" / "api" / "fastapi" / "markdown_context"
