...
from ..auth.schemes import oauth2_scheme # MODIFIED: Import from new central location
...
async def get_current_supabase_client(
    token: Optional[str] = Depends(oauth2_scheme), # Uses the centrally defined oauth2_scheme
