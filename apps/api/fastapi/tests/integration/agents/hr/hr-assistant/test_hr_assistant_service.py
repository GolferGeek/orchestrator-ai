...
from apps.api.fastapi.agents.hr.hr_assistant.main import (
...
from apps.api.fastapi.a2a_protocol.types import Message, TextPart, TaskSendParams, TaskState # Added TaskState, TaskSendParams
from apps.api.fastapi.shared.mcp.mcp_client import MCPConnectionError, MCPTimeoutError, MCPError # For error scenario testing
