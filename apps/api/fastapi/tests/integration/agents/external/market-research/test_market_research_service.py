...
from apps.api.fastapi.agents.external.market_research.main import AGENT_VERSION as MARKET_RESEARCH_AGENT_VERSION
from apps.api.fastapi.a2a_protocol.types import Message, TextPart, TaskSendParams # Ensure TaskSendParams is imported
