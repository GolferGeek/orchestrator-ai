...
from apps.api.fastapi.agents.external.competitors.main import AGENT_VERSION as COMPETITORS_VERSION
from apps.api.fastapi.a2a_protocol.types import Message, TextPart, TaskSendParams
