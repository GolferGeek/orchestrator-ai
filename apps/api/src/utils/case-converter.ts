...
export function mapEnhancedMessageToDb(message: Partial<EnhancedMessage>): any {
  return {
    ...
    user_rating: message.userRating,
    speed_rating: message.speedRating,
    accuracy_rating: message.accuracyRating,
    user_notes: message.userNotes,
    evaluation_timestamp: message.evaluationTimestamp,
    cidafm_options: message.cidafmOptions,
    evaluation_details: message.evaluationDetails,
  };
}
...
export function mapUserUsageStatsToDb(stats: Partial<UserUsageStats>): any {
  return {
    ...
    avg_user_rating: stats.avgUserRating,
