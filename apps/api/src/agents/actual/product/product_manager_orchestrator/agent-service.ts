...
@Injectable()
export class ProductManagerOrchestratorService extends OrchestratorAgentBaseService {
  protected readonly logger = new Logger(ProductManagerOrchestratorService.name);
   ...
   */
  getAgentName(): string {
    return 'product_manager_orchestrator';
  }
}