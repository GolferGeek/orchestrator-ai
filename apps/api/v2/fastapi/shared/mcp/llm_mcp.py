...
async def _load_agent_context(agent_id: str) -> str:
    ...
    context_file_paths = [
        project_root / "shared" / "markdown_context" / f"{agent_id}_agent.md",  # First try: agent_id_agent.md
        project_root / "shared" / "markdown_context" / f"{agent_id}Agent.md",   # Second try: agentIdAgent.md
        project_root / "shared" / "markdown_context" / f"{agent_id}.md"         # Third try: agent_id.md
    ]
    ...
    if not found_path:
        ...
        alt_context_paths = [
            alternate_project_root / "shared" / "markdown_context" / f"{agent_id}_agent.md",
            alternate_project_root / "shared" / "markdown_context" / f"{agent_id}Agent.md",
            alternate_project_root / "shared" / "markdown_context" / f"{agent_id}.md"
        ]
