...
# A2A Protocol and Task Store - Fix to 4 dots to reach fastapi level
...
from ....main import get_original_openai_service as get_openai_service

# HTTP Client Dependency
from ....main import get_original_http_client as get_http_client

# Orchestrator Service
from .service import OrchestratorAgentService

# Supabase Client
from supabase import Client as SupabaseClient
from ....auth.dependencies import get_supabase_client_as_current_user # For user-specific client
...
def get_agent_service(
    ...
    # Temporarily disable auth requirement for V2 development
    # supabase_client: Optional[SupabaseClient] = Depends(get_supabase_client_as_current_user)
    ...
    return OrchestratorAgentService(
        ...
        supabase_client=None  # Temporarily None for development
