...
from apps.api.v2.fastapi.agents.customer.chat_support.main import ChatSupportService, AGENT_ID as CHAT_SUPPORT_AGENT_ID, AGENT_NAME as CHAT_SUPPORT_AGENT_NAME, AGENT_VERSION as CHAT_SUPPORT_AGENT_VERSION
from apps.api.v2.fastapi.a2a_protocol.types import Message, TextPart, TaskSendParams
