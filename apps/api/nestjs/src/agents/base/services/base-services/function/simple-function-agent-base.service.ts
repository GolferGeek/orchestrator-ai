...
/**
 * Simplified Function Agent Base Service that uses pre-loaded functions from AgentDiscoveryService
 * This eliminates the complex runtime loading and error handling of the original FunctionAgentBaseService
 */
@Injectable()
export class SimpleFunctionAgentBaseService extends A2AAgentBaseService {
  protected readonly functionLogger = new Logger(SimpleFunctionAgentBaseService.name);
