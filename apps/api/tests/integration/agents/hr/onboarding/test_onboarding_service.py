...
from apps.api.agents.hr.onboarding.main import (
...
async def test_onboarding_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.agents.hr.onboarding.main.MCPClient.query_agent_aggregate",
    ...
    expected_query_for_mcp = f"{actual_onboarding_context_content}\n\nUser Query: {user_query}"
