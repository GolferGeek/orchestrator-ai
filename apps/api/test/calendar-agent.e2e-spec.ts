...
describe('Calendar Agent E2E Test', () => {
  ...
  it('should handle calendar scheduling request successfully', async () => {
    ...
    const taskRequest = {
      method: 'executeTask',
      prompt: 'Schedule a quarterly board meeting with 8 executives across different time zones (EST, PST, GMT, CET). Need to find optimal time slots considering executive availability and provide alternative options if conflicts arise.',
      providerId: null,
      modelId: null,
      temperature: 0.7,
