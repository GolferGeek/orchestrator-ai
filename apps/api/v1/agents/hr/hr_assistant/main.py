...
from apps.api.v1.a2a_protocol.task_store import TaskStoreService # TaskAndHistory removed
...
from apps.api.v1.main import get_original_http_client # Import the http_client provider
