...
from apps.api.v1.fastapi.a2a_protocol.base_agent import A2AAgentBaseService
# from apps.api.v1.fastapi.a2a_protocol.task_store import TaskStoreService # Not strictly needed here if base class handles it
...
from apps.api.v1.fastapi.a2a_protocol.supabase_chat_history import SupabaseChatMessageHistory # Import new history class
...
class OrchestratorService(A2AAgentBaseService):
    ...
    async def handle_task_cancel(self, task_id: str) -> Dict[str, Any]:
        ...
        # from apps.api.v1.fastapi.a2a_protocol.types import TaskState # Local import can be removed if TaskState is at top
