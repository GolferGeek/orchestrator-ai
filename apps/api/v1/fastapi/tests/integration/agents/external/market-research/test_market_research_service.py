...
from apps.api.v1.fastapi.agents.external.market_research.main import AGENT_VERSION as MARKET_RESEARCH_AGENT_VERSION
from apps.api.v1.fastapi.a2a_protocol.types import Message, TextPart, TaskSendParams # Ensure TaskSendParams is imported
