...
from apps.api.v1.fastapi.agents.customer.email_triage.main import EmailTriageService, AGENT_ID as EMAIL_TRIAGE_AGENT_ID, AGENT_NAME as EMAIL_TRIAGE_AGENT_NAME, AGENT_VERSION as EMAIL_TRIAGE_AGENT_VERSION
