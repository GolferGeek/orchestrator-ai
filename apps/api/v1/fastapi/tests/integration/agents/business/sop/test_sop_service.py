...
from apps.api.v1.fastapi.agents.business.sop.main import (
    SopService, 
...
from apps.api.v1.fastapi.a2a_protocol.types import Message, TextPart, TaskSendParams, TaskState # Moved TaskState import
from apps.api.v1.fastapi.shared.mcp.mcp_client import MCPError, MCPConnectionError, MCPTimeoutError # Added for mocking side effects
