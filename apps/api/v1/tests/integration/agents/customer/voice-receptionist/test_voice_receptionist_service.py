...
from apps.api.v1.agents.customer.voice_receptionist.main import VoiceReceptionistService, AGENT_ID as VR_AGENT_ID, AGENT_NAME as VR_AGENT_NAME, AGENT_VERSION as VR_AGENT_VERSION
