...
from apps.api.python.fastapi_v1.agents.external.market_research.main import AGENT_VERSION as MARKET_RESEARCH_AGENT_VERSION
from apps.api.python.fastapi_v1.a2a_protocol.types import Message, TextPart, TaskSendParams # Ensure TaskSendParams is imported
...
async def test_market_research_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.python.fastapi_v1.agents.external.market_research.main.MCPClient.query_agent_aggregate",
