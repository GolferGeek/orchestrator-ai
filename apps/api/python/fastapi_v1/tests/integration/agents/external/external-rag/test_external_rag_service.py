...
from apps.api.python.fastapi_v1.agents.external.external_rag.main import AGENT_VERSION as EXTERNAL_RAG_VERSION
...
async def test_external_rag_process_message_success(
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.python.fastapi_v1.agents.external.external_rag.main.MCPClient.query_agent_aggregate",
