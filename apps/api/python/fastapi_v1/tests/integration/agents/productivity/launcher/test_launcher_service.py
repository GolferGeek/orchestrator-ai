...
from apps.api.python.fastapi_v1.agents.productivity.launcher.main import (
...
async def test_launcher_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_send_to_mcp = mocker.patch(
        "apps.api.python.fastapi_v1.agents.productivity.launcher.main.MCPClient.query_agent_aggregate",
...
async def test_launcher_process_message_unexpected_error_in_service(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mocker.patch(
        "apps.api.python.fastapi_v1.agents.productivity.launcher.main.MCPClient.query_agent_aggregate", # Mock the actual MCP call
        new_callable=AsyncMock,
