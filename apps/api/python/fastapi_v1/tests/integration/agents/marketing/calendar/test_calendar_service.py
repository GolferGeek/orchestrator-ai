...
from apps.api.python.fastapi_v1.agents.marketing.calendar.main import (
...
from apps.api.python.fastapi_v1.a2a_protocol.types import Message, TextPart, TaskSendParams, TaskState # Ensure TaskSendParams is imported
...
async def test_calendar_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.python.fastapi_v1.agents.marketing.calendar.main.MCPClient.query_agent_aggregate",
