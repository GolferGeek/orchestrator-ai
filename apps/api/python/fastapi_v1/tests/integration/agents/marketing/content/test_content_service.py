...
from apps.api.python.fastapi_v1.agents.marketing.content.main import (
...
async def test_content_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.python.fastapi_v1.agents.marketing.content.main.MCPClient.query_agent_aggregate",
