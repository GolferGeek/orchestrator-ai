...
from apps.api.python.fastapi_v1.agents.hr.hr_assistant.main import (
...
from apps.api.python.fastapi_v1.a2a_protocol.types import Message, TextPart, TaskSendParams, TaskState # Added TaskState, TaskSendParams
from apps.api.python.fastapi_v1.shared.mcp.mcp_client import MCPConnectionError, MCPTimeoutError, MCPError # For error scenario testing
...
async def test_hr_assistant_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.python.fastapi_v1.agents.hr.hr_assistant.main.MCPClient.query_agent_aggregate",
