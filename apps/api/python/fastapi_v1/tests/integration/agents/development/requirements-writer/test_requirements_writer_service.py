...
from apps.api.python.fastapi_v1.agents.development.requirements_writer.main import AGENT_VERSION as REQUIREMENTS_WRITER_VERSION
...
async def test_requirements_writer_process_message_success(client_and_app: tuple[httpx.AsyncClient, FastAPI], mocker: AsyncMock):
    ...
    mock_query_aggregate = mocker.patch(
        "apps.api.python.fastapi_v1.agents.development.requirements_writer.main.MCPClient.query_agent_aggregate",
