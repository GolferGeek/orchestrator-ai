...
from apps.api.python.fastapi_v1.agents.business.sop.main import (
    SopService, 
...
from apps.api.python.fastapi_v1.a2a_protocol.types import Message, TextPart, TaskSendParams, TaskState # Moved TaskState import
from apps.api.python.fastapi_v1.shared.mcp.mcp_client import MCPError, MCPConnectionError, MCPTimeoutError # Added for mocking side effects
