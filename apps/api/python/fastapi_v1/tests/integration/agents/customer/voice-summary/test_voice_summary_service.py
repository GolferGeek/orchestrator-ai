...
from apps.api.python.fastapi_v1.agents.customer.voice_summary.main import VoiceSummaryService, AGENT_ID as VS_AGENT_ID, AGENT_NAME as VS_AGENT_NAME, AGENT_VERSION as VS_AGENT_VERSION
