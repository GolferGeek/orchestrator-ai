import pytest
from unittest.mock import AsyncMock, ANY, patch, MagicMock
import uuid
import httpx
from fastapi import FastAPI

from apps.api.python.fastapi_v1.agents.customer.chat_support.main import ChatSupportService, AGENT_ID as CHAT_SUPPORT_AGENT_ID, AGENT_NAME as CHAT_SUPPORT_AGENT_NAME, AGENT_VERSION as CHAT_SUPPORT_AGENT_VERSION
