...
from apps.api.python.fastapi_v1.a2a_protocol.task_store import TaskStoreService # TaskAndHistory removed
...
# from apps.api.v1.core.config import settings # Not directly used in metrics/main.py for agent-specific logic
from apps.api.python.fastapi_v1.shared.mcp.mcp_client import MCPClient # Specific errors handled by base
from apps.api.python.fastapi_v1.main import get_original_http_client # Import the http_client provider
from apps.api.python.fastapi_v1.agents.base.mcp_context_agent_base import MCPContextAgentBaseService # Import the new base class
