 ...
 */
export type StrictPlanRequest = PlanCreateRequest | PlanReadRequest | PlanListRequest | PlanEditRequest | PlanSetCurrentRequest | PlanDeleteVersionRequest | PlanMergeVersionsRequest | PlanCopyVersionRequest | PlanDeleteRequest;
/**
 ...
 */
export type StrictPlanResponse = PlanCreateResponse | PlanReadResponse | PlanListResponse | PlanEditResponse | PlanSetCurrentResponse | PlanDeleteVersionResponse | PlanMergeVersionsResponse | PlanCopyVersionResponse | PlanDeleteResponse;
//# sourceMappingURL=plan.strict.d.ts.map