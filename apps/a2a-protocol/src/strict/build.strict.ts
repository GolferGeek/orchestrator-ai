...
// ============================================================================
// BUILD MODE - REQUEST TYPES (10 actions)
// ============================================================================
 ...
 */
export type StrictBuildRequest =
  | BuildCreateRequest
  | BuildReadRequest
  | BuildListRequest
  | BuildEditRequest
  | BuildSetCurrentRequest
  | BuildDeleteVersionRequest
  | BuildMergeVersionsRequest
  | BuildCopyVersionRequest
  | BuildRerunRequest
  | BuildDeleteRequest;

// ============================================================================
// BUILD MODE - DATA STRUCTURES
// ============================================================================
...
// ============================================================================
// BUILD MODE - RESPONSE TYPES (10 actions)
// ============================================================================
 ...
 */
export type StrictBuildResponse =
  | BuildCreateResponse
  | BuildReadResponse
  | BuildListResponse
  | BuildEditResponse
